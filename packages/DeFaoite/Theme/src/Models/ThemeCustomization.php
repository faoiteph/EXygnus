...
namespace DeFaoite\Theme\Models;

use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use DeFaoite\Admin\Database\Factories\ThemeFactory;
use DeFaoite\Core\Eloquent\TranslatableModel;
use DeFaoite\Theme\Contracts\ThemeCustomization as ThemeCustomizationContract;

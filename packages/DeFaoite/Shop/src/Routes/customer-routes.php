...
use DeFaoite\Core\Http\Middleware\NoCacheMiddleware;
use DeFaoite\Shop\Http\Controllers\Customer\Account\AddressController;
use DeFaoite\Shop\Http\Controllers\Customer\Account\DownloadableProductController;
use DeFaoite\Shop\Http\Controllers\Customer\Account\EUWithdrawalController as CustomerEUWithdrawalController;
use DeFaoite\Shop\Http\Controllers\Customer\Account\OrderController;
use DeFaoite\Shop\Http\Controllers\Customer\Account\RMAController;
use DeFaoite\Shop\Http\Controllers\Customer\Account\WishlistController;
use DeFaoite\Shop\Http\Controllers\Customer\CustomerController;
use DeFaoite\Shop\Http\Controllers\Customer\ForgotPasswordController;
use DeFaoite\Shop\Http\Controllers\Customer\GDPRController;
use DeFaoite\Shop\Http\Controllers\Customer\RegistrationController;
use DeFaoite\Shop\Http\Controllers\Customer\ResetPasswordController;
use DeFaoite\Shop\Http\Controllers\Customer\SessionController;
use DeFaoite\Shop\Http\Controllers\DataGridController;

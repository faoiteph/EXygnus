<div class="grid grid-cols-1 gap-6">
    @if ($bookingProduct->appointment_slot)
        ...
        @if ($bookingProduct->available_every_week)
            @inject ('bookingSlotHelper', 'DeFaoite\BookingProduct\Helpers\AppointmentSlot')
        ...
        app.component('v-toggler', {
            ...
            data() {
                return{
                    ...
                    days: @json($bookingProduct->appointment_slot ? app(\DeFaoite\BookingProduct\Helpers\AppointmentSlot::class)->getWeekSlotDurations($bookingProduct) : []),
                }
            },
        })
    </script>

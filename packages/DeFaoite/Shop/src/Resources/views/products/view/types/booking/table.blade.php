<div class="grid grid-cols-1 gap-6">
    @if ($bookingProduct->table_slot)
        ...
        @if ($bookingProduct->available_every_week)
            @inject ('bookingSlotHelper', 'DeFaoite\BookingProduct\Helpers\TableSlot')
        ...
        app.component('v-toggler', {
            ...
            data() {
                return{
                    ...
                    days: @json($bookingProduct->table_slot ? app(\DeFaoite\BookingProduct\Helpers\TableSlot::class)->getWeekSlotDurations($bookingProduct) : []),
                }
            },
        })
    </script>

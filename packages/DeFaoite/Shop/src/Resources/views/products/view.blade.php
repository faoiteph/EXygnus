@inject ('reviewHelper', 'DeFaoite\Product\Helpers\Review')
@inject ('productViewHelper', 'DeFaoite\Product\Helpers\View')
...
@push('meta')
    ...
    @if (core()->getConfigData('catalog.rich_snippets.products.enable'))
        <script type="application/ld+json">
            {!! app('DeFaoite\Product\Helpers\SEO')->getProductJsonLd($product) !!}
        </script>
    @endif
...
<x-shop::layouts>
    ...
    @pushOnce('scripts')
                    ...
                    <div class="container px-[60px] max-1180:px-0">
                        <div class="mt-12 flex gap-9 max-1180:flex-wrap max-lg:mt-0 max-sm:gap-y-4">
                            ...
                            <div class="relative max-w-[590px] max-1180:w-full max-1180:max-w-full max-1180:px-5 max-sm:px-4">
                                ...
                                @if (\DeFaoite\Tax\Facades\Tax::isInclusiveTaxProductPrices())
                    ...
                    <x-shop::form :action="route('shop.home.contact_us.send_mail')">
                        ...
                        @if (core()->getConfigData('customer.captcha.credentials.status'))
                            <x-shop::form.control-group class="mt-5">
                                {!! \DeFaoite\Customer\Facades\Captcha::render() !!}
        ...
        @if (core()->getConfigData('customer.captcha.credentials.status'))
            {!! \DeFaoite\Customer\Facades\Captcha::renderJS() !!}
        @endif
    @endPushOnce
</x-shop::layouts>

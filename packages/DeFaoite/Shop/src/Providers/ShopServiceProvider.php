...
use DeFaoite\Core\Http\Middleware\PreventRequestsDuringMaintenance;
use DeFaoite\Shop\Http\Middleware\AuthenticateCustomer;
use DeFaoite\Shop\Http\Middleware\CacheResponse;
use DeFaoite\Shop\Http\Middleware\Currency;
use DeFaoite\Shop\Http\Middleware\Locale;
use DeFaoite\Shop\Http\Middleware\Theme;

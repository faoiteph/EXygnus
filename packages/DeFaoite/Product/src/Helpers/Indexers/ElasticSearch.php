...
namespace DeFaoite\Product\Helpers\Indexers;

use Elastic\Elasticsearch\Exception\ClientResponseException;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Support\Facades\DB;
use DeFaoite\Attribute\Contracts\Attribute;
use DeFaoite\Attribute\Enums\AttributeTypeEnum;
use DeFaoite\Attribute\Repositories\AttributeRepository;
use DeFaoite\Core\Contracts\Channel;
use DeFaoite\Core\Contracts\Locale;
use DeFaoite\Core\Facades\ElasticSearch as ElasticSearchClient;
use DeFaoite\Core\Repositories\ChannelRepository;
use DeFaoite\Customer\Repositories\CustomerGroupRepository;
use DeFaoite\Product\Contracts\ProductAttributeValue;
...
class ElasticSearch extends AbstractIndexer
{
     ...
     * Product instance.
     *
     * @var \DeFaoite\Product\Contracts\Product
     */
    protected $product;

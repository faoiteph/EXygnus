...
use DeFaoite\Product\Contracts\ProductDownloadableLinkTranslation as ProductDownloadableLinkTranslationContract;
use DeFaoite\Product\Database\Factories\ProductDownloadableLinkTranslationFactory;

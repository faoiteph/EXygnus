...
use DeFaoite\Admin\Validations\ConfigurableUniqueSku;
use DeFaoite\Checkout\Contracts\CartItem;
use DeFaoite\Checkout\Models\CartItem as CartItemModel;
...
class Configurable extends AbstractType
{
     ...
     * Copy relationships.
     *
     * @param  \DeFaoite\Product\Models\Product  $product
     * @return void
     */
    ...
    {
        $childProduct = app('DeFaoite\Product\Repositories\ProductRepository')->find($data['selected_configurable_option']);
     ...
     *
     * @param  \DeFaoite\Product\Type\CartItem  $item
     */

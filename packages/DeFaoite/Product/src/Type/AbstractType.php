...
namespace DeFaoite\Product\Type;

use Illuminate\Support\Collection;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Storage;
use DeFaoite\Attribute\Contracts\Attribute;
use DeFaoite\Attribute\Contracts\Group;
...
use DeFaoite\Product\Contracts\ProductInventoryIndex;
use DeFaoite\Product\Contracts\ProductPriceIndex;
use DeFaoite\Product\DataTypes\CartItemValidationResult;
use DeFaoite\Product\Exceptions\InsufficientProductInventoryException;
...
use DeFaoite\Product\Repositories\ProductVideoRepository;
use DeFaoite\Sales\Contracts\InvoiceItem;
use DeFaoite\Sales\Contracts\OrderItem;
use DeFaoite\Sales\Contracts\ShipmentItem;
...
abstract class AbstractType
{
     ...
     * Create product.
     *
     * @return \DeFaoite\Product\Contracts\Product
     */
     ...
     *
     * @param  \DeFaoite\Checkout\Contracts\CartItem  $cartItem
     * @return bool
     */
     ...
     *
     * @param  \DeFaoite\Checkout\Contracts\CartItem  $item
     * @return bool
     */
     ...
     *
     * @param  \DeFaoite\Checkout\Contracts\CartItem  $item
     * @return \DeFaoite\Checkout\Contracts\CartItem|OrderItem|InvoiceItem|ShipmentItem|Wishlist
     */
     ...
     *
     * @param  \DeFaoite\Customer\Contracts\CartItem|\DeFaoite\Checkout\Contracts\CartItem  $item
     * @return array
     */
     ...
     */
    public function isCartItemInactive(\DeFaoite\Checkout\Contracts\CartItem $item): bool
    {

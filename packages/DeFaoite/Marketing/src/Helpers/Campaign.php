...
namespace DeFaoite\Marketing\Helpers;

use Carbon\Carbon;
use Illuminate\Support\Facades\Mail;
use DeFaoite\Core\Models\SubscribersList;
use DeFaoite\Marketing\Mail\NewsletterMail;
use DeFaoite\Marketing\Repositories\CampaignRepository;
use DeFaoite\Marketing\Repositories\EventRepository;
...
class Campaign
{
     ...
     *
     * @param  \DeFaoite\Marketing\Contracts\Campaign  $campaign
     * @return array
     */

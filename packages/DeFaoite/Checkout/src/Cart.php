...
namespace DeFaoite\Checkout;

use Illuminate\Support\Facades\Event;
use DeFaoite\Checkout\Contracts\CartAddress as CartAddressContract;
use DeFaoite\Checkout\Exceptions\BillingAddressNotFoundException;
use DeFaoite\Checkout\Models\CartAddress;
use DeFaoite\Checkout\Models\CartPayment;
use DeFaoite\Checkout\Repositories\CartAddressRepository;
use DeFaoite\Checkout\Repositories\CartItemRepository;
use DeFaoite\Checkout\Repositories\CartRepository;
use DeFaoite\Customer\Contracts\Customer as CustomerContract;
use DeFaoite\Customer\Contracts\Wishlist as WishlistContract;
use DeFaoite\Customer\Repositories\CustomerAddressRepository;
use DeFaoite\Customer\Repositories\WishlistRepository;
use DeFaoite\Product\Contracts\Product as ProductContract;
use DeFaoite\Product\Repositories\ProductRepository;
use DeFaoite\Shipping\Facades\Shipping;
use DeFaoite\Tax\Facades\Tax;
use DeFaoite\Tax\Repositories\TaxCategoryRepository;

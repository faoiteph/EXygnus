...
namespace DeFaoite\Razorpay\Payment;

use Illuminate\Support\Facades\Storage;
use Razorpay\Api\Api;
use DeFaoite\Checkout\Facades\Cart;
use DeFaoite\Payment\Payment\Payment;
...
class RazorpayPayment extends Payment
{
    ...
    public function getImage()
    {
        ...
        return $url ? Storage::url($url) : exygnus_asset('images/razorpay.png', 'shop');
    }
     ...
     *
     * @param  \DeFaoite\Checkout\Contracts\Cart|null  $cart
     * @return array
     *
     * @throws \Exception
     */

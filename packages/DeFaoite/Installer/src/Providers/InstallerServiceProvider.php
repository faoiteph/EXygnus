...
namespace DeFaoite\Installer\Providers;

use Illuminate\Routing\Router;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\ServiceProvider;
use DeFaoite\Installer\Console\Commands\Installer as InstallerCommand;
use DeFaoite\Installer\Http\Middleware\CanInstall;
use DeFaoite\Installer\Http\Middleware\Locale;
use DeFaoite\Installer\Http\Middleware\UseFileSession;

...
namespace DeFaoite\Category\Models;
...
use DeFaoite\Category\Contracts\Category as CategoryContract;
use DeFaoite\Category\Database\Factories\CategoryFactory;
use DeFaoite\Core\Eloquent\TranslatableModel;
use DeFaoite\Product\Models\ProductProxy;

...
namespace DeFaoite\CartRule\Helpers;

use Carbon\Carbon;
use Illuminate\Database\Eloquent\Builder;
use Illuminate\Support\Collection;
use DeFaoite\CartRule\Repositories\CartRuleCouponRepository;
use DeFaoite\CartRule\Repositories\CartRuleCouponUsageRepository;
use DeFaoite\CartRule\Repositories\CartRuleCustomerRepository;
use DeFaoite\CartRule\Repositories\CartRuleRepository;
use DeFaoite\Checkout\Contracts\Cart;
use DeFaoite\Checkout\Models\CartItem;
use DeFaoite\Customer\Repositories\CustomerRepository;
use DeFaoite\Rule\Helpers\Validator;
...
class CartRule
{
     ...
     *
     * @param  \DeFaoite\CartRule\Contracts\CartRule  $rule
     */
    ...
    protected function resolveCanProcessRule($rule): bool
    {
        if ($rule->coupon_type) {
            ...
            /** @var \DeFaoite\CartRule\Models\CartRule $rule */

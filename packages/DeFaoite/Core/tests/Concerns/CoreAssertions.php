...
namespace DeFaoite\Core\Tests\Concerns;

use DeFaoite\CartRule\Contracts\CartRule;
use DeFaoite\CartRule\Contracts\CartRuleCoupon;
use DeFaoite\CatalogRule\Contracts\CatalogRule;
use DeFaoite\Checkout\Contracts\Cart;
use DeFaoite\Checkout\Contracts\CartItem;
use DeFaoite\Checkout\Contracts\CartPayment;
use DeFaoite\Checkout\Contracts\CartShippingRate;
use DeFaoite\Sales\Contracts\InvoiceItem;
use DeFaoite\Sales\Contracts\OrderItem;
use DeFaoite\Sales\Contracts\OrderPayment;

...
namespace DeFaoite\Core;

use Carbon\Carbon;
use Illuminate\Support\Collection;
use Illuminate\Support\Facades\DB;
use DeFaoite\Core\Concerns\CurrencyFormatter;
...
use DeFaoite\Core\Repositories\CountryRepository;
use DeFaoite\Core\Repositories\CountryStateRepository;
use DeFaoite\Core\Repositories\CurrencyRepository;
use DeFaoite\Core\Repositories\ExchangeRateRepository;
use DeFaoite\Core\Repositories\LocaleRepository;
...
class Core
{
     ...
     *
     * @return \DeFaoite\Customer\Contract\CustomerGroup
     */

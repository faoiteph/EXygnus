...
namespace DeFaoite\DataTransfer\Helpers\Importers\Product;
...
use DeFaoite\Attribute\Repositories\AttributeOptionRepository;
use DeFaoite\Attribute\Repositories\AttributeRepository;
use DeFaoite\BookingProduct\Repositories\BookingProductRepository;
use DeFaoite\Category\Repositories\CategoryRepository;
use DeFaoite\Core\Repositories\ChannelRepository;
use DeFaoite\Core\Rules\Decimal;
use DeFaoite\Core\Rules\Slug;
use DeFaoite\Customer\Repositories\CustomerGroupRepository;
use DeFaoite\DataTransfer\Contracts\ImportBatch as ImportBatchContract;
use DeFaoite\DataTransfer\Helpers\Import;
use DeFaoite\DataTransfer\Helpers\Importers\AbstractImporter;
use DeFaoite\DataTransfer\Helpers\Importers\Concerns\DownloadsImages;
use DeFaoite\DataTransfer\Repositories\ImportBatchRepository;
use DeFaoite\Inventory\Repositories\InventorySourceRepository;
use DeFaoite\Product\Helpers\Indexers\Flat as FlatIndexer;
use DeFaoite\Product\Jobs\ElasticSearch\DeleteIndex as DeleteIndexJob;
use DeFaoite\Product\Jobs\ElasticSearch\UpdateCreateIndex as UpdateCreateElasticSearchIndexJob;
use DeFaoite\Product\Jobs\UpdateCreateInventoryIndex as UpdateCreateInventoryIndexJob;
use DeFaoite\Product\Jobs\UpdateCreatePriceIndex as UpdateCreatePriceIndexJob;
use DeFaoite\Product\Models\Product as ProductModel;
use DeFaoite\Product\Repositories\ProductAttributeValueRepository;
use DeFaoite\Product\Repositories\ProductBundleOptionProductRepository;
use DeFaoite\Product\Repositories\ProductBundleOptionRepository;
use DeFaoite\Product\Repositories\ProductCustomerGroupPriceRepository;
use DeFaoite\Product\Repositories\ProductFlatRepository;

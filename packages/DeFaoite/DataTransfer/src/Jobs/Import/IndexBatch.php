...
namespace DeFaoite\DataTransfer\Jobs\Import;
...
use DeFaoite\DataTransfer\Helpers\Import as ImportHelper;
use DeFaoite\DataTransfer\Jobs\Concerns\BoundedByRetryAfter;
use DeFaoite\DataTransfer\Jobs\Concerns\RetriesOnDeadlock;
...
class IndexBatch implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            $this->retryOnDeadlock(fn () => $typeImported->indexBatch($this->importBatch));
        } finally {

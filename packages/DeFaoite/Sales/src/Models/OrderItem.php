...
use DeFaoite\BookingProduct\Models\BookingProxy;
use DeFaoite\Product\Type\AbstractType;
use DeFaoite\Sales\Contracts\OrderItem as OrderItemContract;
use DeFaoite\Sales\Database\Factories\OrderItemFactory;

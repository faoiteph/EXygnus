...
use DeFaoite\Sales\Contracts\Invoice as InvoiceContract;
use DeFaoite\Sales\Database\Factories\InvoiceFactory;
use DeFaoite\Sales\Traits\InvoiceReminder;
use DeFaoite\Sales\Traits\PaymentTerm;

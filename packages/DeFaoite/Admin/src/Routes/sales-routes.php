...
use DeFaoite\Admin\Http\Controllers\Sales\BookingController;
use DeFaoite\Admin\Http\Controllers\Sales\BookingProductController;
use DeFaoite\Admin\Http\Controllers\Sales\CartController;
use DeFaoite\Admin\Http\Controllers\Sales\EUWithdrawalController;
use DeFaoite\Admin\Http\Controllers\Sales\InvoiceController;
use DeFaoite\Admin\Http\Controllers\Sales\OrderController;
use DeFaoite\Admin\Http\Controllers\Sales\RefundController;
use DeFaoite\Admin\Http\Controllers\Sales\RMA\CustomFieldController;
use DeFaoite\Admin\Http\Controllers\Sales\RMA\ReasonController;
use DeFaoite\Admin\Http\Controllers\Sales\RMA\RequestController;
use DeFaoite\Admin\Http\Controllers\Sales\RMA\RulesController;
use DeFaoite\Admin\Http\Controllers\Sales\RMA\StatusController;
use DeFaoite\Admin\Http\Controllers\Sales\ShipmentController;
use DeFaoite\Admin\Http\Controllers\Sales\TransactionController;

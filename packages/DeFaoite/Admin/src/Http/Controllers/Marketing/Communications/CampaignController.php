...
namespace DeFaoite\Admin\Http\Controllers\Marketing\Communications;

use Illuminate\Http\JsonResponse;
use Illuminate\Http\Response;
use Illuminate\Support\Facades\Event;
use Illuminate\View\View;
use DeFaoite\Admin\DataGrids\Marketing\Communications\CampaignDataGrid;
use DeFaoite\Admin\Http\Controllers\Controller;
use DeFaoite\Marketing\Repositories\CampaignRepository;
use DeFaoite\Marketing\Repositories\TemplateRepository;

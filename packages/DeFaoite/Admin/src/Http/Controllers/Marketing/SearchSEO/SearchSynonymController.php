...
namespace DeFaoite\Admin\Http\Controllers\Marketing\SearchSEO;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\Facades\Storage;
use Illuminate\View\View;
use DeFaoite\Admin\DataGrids\Marketing\SearchSEO\SearchSynonymDataGrid;
use DeFaoite\Admin\Http\Controllers\Controller;
use DeFaoite\Admin\Http\Requests\MassDestroyRequest;
use DeFaoite\Marketing\Repositories\SearchSynonymRepository;

...
namespace DeFaoite\Admin\Http\Controllers\Settings;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Facades\Event;
use Illuminate\View\View;
use DeFaoite\Admin\DataGrids\Settings\ExchangeRatesDataGrid;
use DeFaoite\Admin\Http\Controllers\Controller;
use DeFaoite\Core\Helpers\Exchange\ExchangeRate;

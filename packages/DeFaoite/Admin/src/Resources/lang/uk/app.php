...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Пароль',
            'powered-by-description' => 'Працює на платформі :exygnus, спільний проект :faoite.',
            'submit-btn' => 'Увійти',
            'title' => 'Увійти',
        ],
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Усе, що потрібно, щоб отримати максимум від EXygnus — хостинг, підтримка та професійні послуги, а також розширення й документація для розробників.',

            'services-title' => 'Послуги',
            'resources-title' => 'Ресурси та документація',

            'cloud-hosting' => 'Хмарний хостинг',
            'cloud-hosting-info' => 'Економічний керований хмарний хостинг — запустіть свій магазин EXygnus у хмарі за лічені хвилини, повністю оптимізований і масштабований.',
            ...
            'extensions-info' => 'Перегляньте офіційні та спільнотні доповнення, щоб розширити EXygnus новими конекторами, каналами та функціями.',
            ...
            'api-docs-info' => 'Повний довідник REST та GraphQL API з кінцевими точками, автентифікацією та прикладами для інтеграції EXygnus з вашим стеком.',

            'community' => 'Форум спільноти',
            'community-info' => 'Ставте запитання, діліться ідеями та спілкуйтеся з тисячами розробників і продавців EXygnus по всьому світу.',
            ...
            'cta-description' => 'Поговоріть із командою EXygnus про хостинг, індивідуальну розробку чи будь-що інше.',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Ваш драйвер пошти встановлено на ":driver" замість "exygnus-dynamic-smtp". будь-які зміни, зроблені тут, не матимуть жодного ефекту. Будь ласка, оновіть MAIL_MAILER=exygnus-dynamic-smtp у вашому файлі .env, щоб активувати ці налаштування.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Працює на платформі :exygnus, спільний проект :faoite.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Працює на платформі <a href="https://exygnus.com/" target="_blank">EXygnus</a>, Спільний проект <a href="https://faoite.com/" target="_blank">DeFaoite</a>',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Дії',
            'actions_note' => 'Повернення обробляються вручну за допомогою наявних інструментів EXygnus: замовлень, повернень та RMA. Скористайтеся цими діями, щоб зафіксувати результат у матеріалах про відмову від договору.',

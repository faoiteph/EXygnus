...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'رمز عبور',
            'powered-by-description' => 'قدرت گرفته از :exygnus، یک پروژه متن‌باز توسط :faoite.',
            'submit-btn' => 'ورود',
            'title' => 'ورود',
        ],
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'هر آنچه برای بهره‌گیری حداکثری از EXygnus نیاز دارید — میزبانی، پشتیبانی و خدمات حرفه‌ای، به‌همراه افزونه‌ها و مستندات توسعه‌دهندگان.',

            'services-title' => 'خدمات',
            'resources-title' => 'منابع و مستندات',

            'cloud-hosting' => 'میزبانی ابری',
            'cloud-hosting-info' => 'میزبانی ابری مدیریت‌شده و مقرون‌به‌صرفه — فروشگاه EXygnus خود را در چند دقیقه روی فضای ابری راه‌اندازی کنید، کاملاً بهینه و مقیاس‌پذیر.',
            ...
            'extensions-info' => 'افزونه‌های رسمی و انجمنی را مرور کنید تا EXygnus را با کانکتورها، کانال‌ها و قابلیت‌های جدید گسترش دهید.',
            ...
            'api-docs-info' => 'مرجع کامل API REST و GraphQL با نقاط پایانی، احراز هویت و نمونه‌ها برای یکپارچه‌سازی EXygnus با مجموعه ابزارهای شما.',

            'community' => 'انجمن کاربران',
            'community-info' => 'پرسش‌ها را مطرح کنید، ایده‌ها را به اشتراک بگذارید و با هزاران توسعه‌دهنده و فروشنده EXygnus در سراسر جهان ارتباط برقرار کنید.',
            ...
            'cta-description' => 'درباره میزبانی، توسعه سفارشی یا هر موضوع دیگری با تیم EXygnus صحبت کنید.',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'درایور ایمیل شما به جای "exygnus-dynamic-smtp" روی ":driver" تنظیم شده است. هرگونه تغییری که در اینجا ایجاد شود بی‌اثر خواهد بود. لطفاً MAIL_MAILER=exygnus-dynamic-smtp را در فایل .env خود به‌روزرسانی کنید تا این تنظیمات فعال شوند.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'قدرت گرفته از :exygnus، یک پروژه متن‌باز توسط :faoite.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'قدرت گرفته از <a href="https://exygnus.com/" target="_blank">EXygnus</a>، یک پروژه اجتماعی توسط <a href="https://faoite.com/" target="_blank">DeFaoite</a>',
    ],

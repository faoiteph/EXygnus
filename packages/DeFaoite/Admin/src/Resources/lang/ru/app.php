...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Пароль',
            'powered-by-description' => 'Работает на :exygnus, проект с открытым исходным кодом от :faoite.',
            'submit-btn' => 'Войти',
            'title' => 'Войти',
        ],
    ...
    'help' => [
        'index' => [
            ...
            'description' => 'Всё необходимое, чтобы получить максимум от EXygnus — хостинг, поддержка и профессиональные услуги, а также расширения и документация для разработчиков.',

            'services-title' => 'Услуги',
            'resources-title' => 'Ресурсы и документация',

            'cloud-hosting' => 'Облачный хостинг',
            'cloud-hosting-info' => 'Экономичный управляемый облачный хостинг — запустите свой магазин EXygnus в облаке за считаные минуты, полностью оптимизированный и масштабируемый.',
            ...
            'extensions-info' => 'Просматривайте официальные и созданные сообществом дополнения, чтобы расширить EXygnus новыми коннекторами, каналами и функциями.',
            ...
            'api-docs-info' => 'Полный справочник по REST и GraphQL API с конечными точками, аутентификацией и примерами для интеграции EXygnus с вашими системами.',

            'community' => 'Форум сообщества',
            'community-info' => 'Задавайте вопросы, делитесь идеями и общайтесь с тысячами разработчиков и продавцов EXygnus по всему миру.',
            ...
            'cta-description' => 'Обратитесь к команде EXygnus по вопросам хостинга, индивидуальной разработки или чего-либо ещё.',
    ...
    'configuration' => [
        'index' => [
            ...
            'email' => [
                ...
                'smtp' => [
                    'driver-mismatch-info' => 'Ваш почтовый драйвер установлен на ":driver" вместо "exygnus-dynamic-smtp". Любые изменения, внесенные здесь, не будут иметь эффекта. Пожалуйста, обновите MAIL_MAILER=exygnus-dynamic-smtp в вашем файле .env, чтобы активировать эти настройки.',
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Работает на :exygnus, проект с открытым исходным кодом от :faoite.',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Разработано на платформе <a href="https://exygnus.com/" target="_blank">EXygnus</a>, Проект сообщества <a href="https://faoite.com/" target="_blank">DeFaoite</a>',
    ],
    ...
    'eu_withdrawal' => [
        ...
        'view' => [
            ...
            'actions' => 'Действия',
            'actions_note' => 'Возвраты обрабатываются вручную с помощью существующих инструментов EXygnus: заказов, возвратов и RMA. Используйте эти действия, чтобы зафиксировать результат в материалах об отказе от договора.',

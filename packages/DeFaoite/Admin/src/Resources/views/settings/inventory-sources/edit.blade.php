<x-admin::layouts>
    ...
    {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.before', ['inventorySource' => $inventorySource]) !!}
    ...
    >
        ...
        {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.edit_form_controls.before', ['inventorySource' => $inventorySource]) !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.card.general.before', ['inventorySource' => $inventorySource]) !!}
                ...
                {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.card.general.after', ['inventorySource' => $inventorySource]) !!}

                {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.card.contact_info.before', ['inventorySource' => $inventorySource]) !!}
                ...
                {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.card.contact_info.after', ['inventorySource' => $inventorySource]) !!}

                {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.card.source_address.before', ['inventorySource' => $inventorySource]) !!}

                <!-- Create Inventory -->
                <v-source-address></v-source-address>

                {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.card.source_address.after', ['inventorySource' => $inventorySource]) !!}
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2">
                ...
                {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.card.accordion.settings.before', ['inventorySource' => $inventorySource]) !!}
                ...
                {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.card.accordion.settings.after', ['inventorySource' => $inventorySource]) !!}

            </div>
        </div>

        {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.edit_form_controls.after', ['inventorySource' => $inventorySource]) !!}

    </x-admin::form>

    {!! view_render_event('exygnus.admin.settings.inventory_sources.edit.after', ['inventorySource' => $inventorySource]) !!}

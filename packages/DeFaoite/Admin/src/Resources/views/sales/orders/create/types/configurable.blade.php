{!! view_render_event('exygnus.admin.sales.order.create.types.configurable.before') !!}
...
{!! view_render_event('exygnus.admin.sales.order.create.types.configurable.after') !!}
